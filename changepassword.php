      ...
      <?php
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
          if (empty($_POST["currentPassword"]))
          ...
          else
	       {
            $currentPassword = test_input($_POST["currentPassword"]);
             if (strcmp($currentPassword,"1234Anika"))
		        {
                $cpasswordError= "The password is incorrect!";
            }     
	       }
          ...
          if (empty($_POST["newpassword"])) 
            ...
            if (!strcmp($newpassword,"1234Anika"))
		        {
                 $npasswordError = "Current and New password can not be same!";
            }  
		      }
          ...
          if (empty($_POST["rnewpassword"]))
          ...
          else 
    		   {
                $rnewpassword = test_input($_POST["rnewpassword"]);
    			 ...
    			 {
                   $rnpassworderror = "password is not same!";
                 }
       ...
       function test_input($data) 
       {
	     ...
	     <div>
          ...
          <br>
          <legend> <h2 style="background-color:powderblue;">CHANGE PASSWORD </h2> </legend>
          ...
          <label style="color:Red">Repeat Password :</label>
